...
# Два шага: (1) подпапки: SeasonFolderMatchRegex («.S01.», …), «N сезон», либо «Season_01» / «Season 8» → «Сезон N»; если все папки уже «Сезон N», для шага .S01/релиз — в лог пишется SKIP. (2) внутри «Сезон N» — файлы с тегом S01E01 или «.S1.E01.» (см. Get-EpisodeNumbersFromVideoFilename) → «Сериал - S01E01 - название».
...
Скрипт: (1) папки с «.S01.», «( S01 )», «… S01 …» (релиз), либо «1 сезон», «2 сезон», либо «Season_01» / «Season 8» → «Сезон 1»; если папки уже «Сезон N», шаг для .S01/релиза только пропускается; (2) внутри «Сезон N» — файлы с S01E01 или .S1.E01. в имени.
...
Script: (1) folders with «.S01.», «( S01 )», release «… S01 …», «1 сезон» / «2 сезон», or «Season_01» / «Season 8» → «Сезон N»; if already «Сезон N», the release step is skipped; (2) inside «Сезон N» — files with S01E01 or «.S1.E01.» in the filename.
