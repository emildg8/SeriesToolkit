...
function Show-RenameOutcomeDialog([string]$SeriesBase) {
    ...
    $lbl.Height = 88
    # В FontStyle нет Semibold — только Regular/Bold/…; начертание «полужирный» задаётся гарнитурой Segoe UI Semibold.
    $lbl.Font = New-UiFont 'Segoe UI Semibold' 10 ([System.Drawing.FontStyle]::Regular)
    $lbl.Text = @'
