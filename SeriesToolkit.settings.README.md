...
| `strict_mode` | Если `true`, toolkit не создаёт рискованные переименования с заглушкой (`Серия N`) при отсутствии подтверждённого названия: такие случаи уходят в review-очередь. |
...
Пример aliases-файла (`series-aliases.json`):
