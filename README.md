...
- кнопки **Пауза / Продолжить** и **Стоп** без закрытия окна.
...
У EXE используется иконка `assets/SeriesToolkit.icon.ico`; при сборке старый `SeriesToolkit.GUI.exe` автоматически ротируется в `.bak`.
